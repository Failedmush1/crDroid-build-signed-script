...
```sh
wget [https://raw.githubusercontent.com/306bobby-android/crDroid-build-signed-script/main/create-signed-env.sh](https://raw.githubusercontent.com/Failedmush1/crDroid-build-signed-script/refs/heads/main/create-signed-env.sh)
