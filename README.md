...
```sh
wget [https://raw.githubusercontent.com/Failedmush1/crDroid-build-signed-script/refs/heads/main/create-signed-env.sh](https://raw.githubusercontent.com/Failedmush1/crDroid-build-signed-script/refs/heads/main/create-signed-env.sh)
...
3. Hit enter to set no password for each certificate  
**Cannot set a password to build inline with this method!**

### Prep device tree (for other ROMs - not needed on crDroid)
